...
/**
 * A uim standard implementation of a workflow task. This task is passed through the workflow and
 * setup before each workflow step by the framework.
 * 
...
public class UIMTask implements Task {
    ...
    @Override
    public void setStep(IngestionPlugin step) {
        this.step = step;
    }
