...
package eu.europeana.uim.util.sugarcrm.polling;

import java.util.List;
import eu.europeana.uim.util.sugarcrm.SugarCRMService;
import eu.europeana.uim.util.sugarcrm.SugarCrmQuery;
import eu.europeana.uim.util.sugarcrm.SugarCrmRecord;
import eu.europeana.uim.util.sugarcrm.exceptions.GenericSugarCRMException;
