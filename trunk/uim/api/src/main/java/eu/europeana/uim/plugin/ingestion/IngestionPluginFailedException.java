...
/**
 * This exception is thrown when the plugin encounters a major error for this specific
 * {@link ExecutionContext}. In other words, necessary information to fulfill the task of the plugin
 * are corrupted or missing and it is therefore not possible to proceed with the work on any record
 * at all. This exception can also be thrown during initialization and completion of the plugin.
 * 
