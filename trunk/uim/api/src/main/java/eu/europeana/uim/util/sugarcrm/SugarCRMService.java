...
import eu.europeana.uim.util.sugarcrm.data.DatasetStates;
import eu.europeana.uim.util.sugarcrm.data.UpdatableField;
import eu.europeana.uim.util.sugarcrm.exceptions.FileAttachmentException;
import eu.europeana.uim.util.sugarcrm.exceptions.LoginFailureException;
import eu.europeana.uim.util.sugarcrm.exceptions.QueryResultException;
import eu.europeana.uim.util.sugarcrm.polling.PollingListener;
...
public interface SugarCRMService {
	 ...
	 * 
	 * @param recordID the Record ID
	 * @param values a map containing <EuropeanaUpdatableField,String> key/value pairs
	 * @throws QueryResultException
	 */
	 ...
	 * 
	 * @param record the SugarCrmRecordImpl object
	 * @throws QueryResultException
	 */
