...
public interface SugarCrmService {
	 ...
	 * @throws StorageEngineException
	 */
	public Provider<?> updateProviderFromRecord(SugarCrmRecord record) throws StorageEngineException;
	 ...
	 * @throws StorageEngineException
	 */
	public Collection<?> updateCollectionFromRecord(SugarCrmRecord record,Provider<?> provider) throws StorageEngineException;
