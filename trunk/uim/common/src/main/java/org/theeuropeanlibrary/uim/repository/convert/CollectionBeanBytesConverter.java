...
public class CollectionBeanBytesConverter extends Converter<byte[], CollectionBean> {
    /**
     * Single convenience instance of a string type converter
     */
    public static final CollectionBeanBytesConverter INSTANCE = new CollectionBeanBytesConverter();
    ...
    @Override
    public CollectionBean<Long> decode(byte[] data) {
