...
/**
 * Simple wrapper around a LinkedHashMap with a maximum number of elements to implement a Least Recently Used cache. 
 * @param <K> key type
 * @param <V> value type
 * 
...
public class LruCache<K, V> extends LinkedHashMap<K, V> {
     ...
     * @param maximum maximum number of entries
     * @param initialCapacity the initial size of the underlying HashMap
     * @param loadFactor the load factor. If the hash map is filled larger than that number, the size is automatically increased.
     */
