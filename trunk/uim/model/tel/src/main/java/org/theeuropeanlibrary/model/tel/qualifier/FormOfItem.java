...
/**
 * FIELD 008 Character 22 and 006 char 5 MAPPING (Continuing Resources): form original item
 * FIELD 008 Character 23 and 006 Char 06 MAPPING (Book, Computer Files, Music, Mixed material, Continuing Resource): Form of Item
 * UNIMARC DATAFIELD 106 $a Char 00 MAPPING: FORM OF ITEM
...
public enum FormOfItem {
	...
	/** 
	 *	MARC21  '-'
	 *  UNIMARC code 'i'(e.g. an item in regular print with a microfiche supplement)
	 */
	MULTIMEDIA,
