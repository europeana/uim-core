...
/**
 * The rules the cataloguer followed when creating the record.
 * This information is relevant for data cleaning tasks, suvh as the removal of ISBD punctuation, parsing of titles, etc.
 * 
