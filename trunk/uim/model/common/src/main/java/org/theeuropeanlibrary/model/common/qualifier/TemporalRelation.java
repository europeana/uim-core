...
public enum TemporalRelation {
	...
	COPYRIGHT,
    /**
     * An unqualified date associated with the resource. The specific semantics
     * of the date is unknown
     */
    GENERAL,
    /**
     * the content of dc:date, it has clearly something to to with creation or
     * availability, but it is not specified which of these.
     */
