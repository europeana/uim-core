 ...
 * @since Apr 27, 2011
 */
public class CurrentExecutionWidget extends IngestionCockpitWidget {
    /**
     * The UiBinder interface used by this example.
     */
    interface Binder extends UiBinder<Widget, CurrentExecutionWidget> {
    }
     ...
     * @param description
     */
    public CurrentExecutionWidget(String name, String description) {
...
// ContactDatabase.get().addDataDisplay(cellTable);
    ...
    protected void asyncOnInitialize(final AsyncCallback<Widget> callback) {
        GWT.runAsync(CurrentExecutionWidget.class, new RunAsyncCallback() {
