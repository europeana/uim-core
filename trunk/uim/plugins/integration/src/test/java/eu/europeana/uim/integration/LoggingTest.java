...
// hand here
                ...
                mavenBundle().groupId("org.dom4j").artifactId("com.springsource.org.dom4j").version(
                        "1.6.1"),
                mavenBundle().groupId("org.apache.commons").artifactId(
                        "com.springsource.org.apache.commons.collections").version("3.2.1"),
                mavenBundle().groupId("org.jboss.javassist").artifactId(
                        "com.springsource.javassist").version("3.9.0.GA"),
                mavenBundle().groupId("javax.persistence").artifactId(
                        "com.springsource.javax.persistence").version("1.0.0"),
                mavenBundle().groupId("org.antlr").artifactId("com.springsource.antlr").version(
                        "2.7.7"),
                mavenBundle().groupId("net.sourceforge.cglib").artifactId(
                        "com.springsource.net.sf.cglib").version("2.2.0"),
                mavenBundle().groupId("javax.xml.stream").artifactId(
                        "com.springsource.javax.xml.stream").version("1.0.1"),
                mavenBundle().groupId("org.objectweb.asm").artifactId(
                        "com.springsource.org.objectweb.asm").version("1.5.3"),
                mavenBundle().groupId("org.objectweb.asm").artifactId(
                        "com.springsource.org.objectweb.asm.attrs").version("1.5.3"),
                mavenBundle().groupId("org.hibernate").artifactId("com.springsource.org.hibernate").version(
                        "3.3.2.GA"),
                mavenBundle().groupId("org.hibernate").artifactId(
                        "com.springsource.org.hibernate.annotations").version("3.3.1.ga"),
                mavenBundle().groupId("org.hibernate").artifactId(
                        "com.springsource.org.hibernate.annotations.common").version("3.3.0.ga"),
                mavenBundle().groupId("org.hibernate").artifactId(
                        "com.springsource.org.hibernate.ejb").version("3.3.2.GA"),
