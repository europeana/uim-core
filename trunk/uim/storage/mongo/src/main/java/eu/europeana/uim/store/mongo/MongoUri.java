...
public class MongoUri extends AbstractMongoEntity implements Uri {
    ...
    private List<MetaDataRecord> metaDataRecord = new ArrayList<MetaDataRecord>(); // all mdr using this url
    ...
    */
    ...
    public MongoUri(long id, String url, ItemType itemType, Request request, MetaDataRecord mdr){
        super(id);
        this.url = url;
        this.itemType = itemType;
    ...
    public void addMetaDataRecord(MetaDataRecord mdr) {
        this.metaDataRecord.add(mdr);
    }

    public void removeMetaDtataRecord(MetaDataRecord mdr) {
        this.metaDataRecord.remove(mdr);
    }
