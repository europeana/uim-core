...
public class MongoResourceEngine extends AbstractEngine implements ResourceEngine {
    ...
    public void initialize() {
        try {
            ...
            morphia.map(CollectionResource.class).map(GlobalResource.class).map(
                    ProviderResource.class).map(WorkflowResource.class).map(
                    MongoProviderDecorator.class).map(MongoExecutionDecorator.class).map(
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#setWorkflowResources(eu.europeana
    ...
    public void setWorkflowResources(Workflow<?, ?> workflow,
        ...
        WorkflowResource wfresource = ds.find(WorkflowResource.class).filter("workflowid",
                workflow.getIdentifier()).get();
        if (wfresource == null) {
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#getWorkflowResources(eu.europeana
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#setProviderResources(eu.europeana
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#getProviderResources(eu.europeana
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#setCollectionResources(eu.europeana
    ...
    public void setCollectionResources(Collection<?> collection,
        ...
        CollectionResource colresource = ds.find(CollectionResource.class).filter("collection",
                collection).get();
        if (colresource == null) {
     ...
     * (non-Javadoc)
     * 
     * @see eu.europeana.uim.api.ResourceEngine#getCollectionResources(eu.europeana
