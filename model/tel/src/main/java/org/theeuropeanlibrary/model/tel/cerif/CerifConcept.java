...
/**
 * Models a Concept in the CERIF subject scheme TODO: in future work, this class
 * concept should support: related concepts and preferred concepts
 *
...
public class CerifConcept {
    ...
    /**
     * The direct narrower concepts (in the CERIF hierarchy) of this one
     ...
     *
     * @param code Unique code for the concept in CERIF
     * @param label English label for the concept in CERIF
     * @param broader The direct broader concept (in the CERIF hierarchy) of
     * this one
     */
    ...
    /**
     * @return the narrower the direct narrower concepts (in the CERIF
     * hierarchy) of this one
     */
