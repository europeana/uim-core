...
/**
 * The bibliographic level of a record relates to the main part of the record, or the primary
 * bibliographic entity described in that record
 * 
...
public enum BibliographicLevel {
    ...
    /**
     * MARC21 code 'd' UNIMARC code -
     */
    SUBUNIT,

    /**
     * MARC21 code 'i' UNIMARC code -
     */
    INTEGRATING_RESOURCE,

    /**
     * MARC21 code 'm' UNIMARC code 'm'
     */
    MONOGRAPH,
