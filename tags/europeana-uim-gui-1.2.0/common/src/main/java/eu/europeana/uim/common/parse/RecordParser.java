...
/**
 * XML parser for documents compliant with a list of simple records. Fields within a single record
 * are of form <fieldName>value</fieldName>.
 * 
...
public class RecordParser {
    ...
    /**
     * Parse method which takes an input stream an the name of the record element. The results are
     * returned as a list of Map's whereby each map represents the content of a single record.
     * 
     * @param stream
     * @param record
    ...
    /**
     * Parse method which takes a stream and a record handler. The record handler is informed about
     * every record read from the stream.
     * 
     * @param stream
     * @param handler
     * @throws XMLStreamParserException
     ...
     * records and the overall progress. Note that due to the stream based parsing, it is not
     * possible to actually inform the monitor about the total amount of work.
     * 
     * @param inputStream
     * @param handler
     * @param monitor
     * @throws XMLStreamParserException
     */
    public void parse(InputStream inputStream, RecordHandler handler, ProgressMonitor monitor)
            throws XMLStreamParserException {
        ...
        try {
            ...
            throw new XMLStreamParserException(
                    "Failed to create XML Stream reader from input stream:" + inputStream);
        }
