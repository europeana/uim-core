...
public abstract class AbstractLinkIngestionPlugin<I> extends
    ...
    /**
     * typed key to retrieve the container holding all execution dependent
     * variables
     */
    ...
    public void completed(ExecutionContext<MetaDataRecord<I>, I> context)
        ...
        log.log(Level.INFO, "Submitted:{0}, Ignored: {1}", new Object[]{value.submitted, value.ignored});
    }

    /**
     * Container holding all execution specific information for the validation
     * plugin.
     */
    protected static class Data implements Serializable {
        ...
        Set<LinkTarget> checktypes = new HashSet<>();
        File directory;
    }
}
