...
/**
 * This class is used as store for a {@link MetaDataRecord} together with a
 * index of a url, and an actual guarded url.s
 *
...
public abstract class GuardedMetaDataRecordUrl<I> extends GuardedUrl {
     ...
     *
     * @param execution
     * @param index the running index of this url
     * @param url link to mdr
     ...
     * @param execution
     *
     * @param mdr the meta data record guarded
     ...
     * @param index the running index of this url
     * @param url link to mdr
     * @param directory the directory to store the downloaded content to.
     */
    public GuardedMetaDataRecordUrl(Execution<I> execution, MetaDataRecord<I> mdr, Link link,
