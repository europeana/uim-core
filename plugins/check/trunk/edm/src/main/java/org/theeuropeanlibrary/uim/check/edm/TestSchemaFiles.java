    ...
    public static void main(String[] args) throws Exception {
        {
            ...
            try {
                File edmXsdFile=new File("C:\\Documents\\EclipseWorkspaces\\TEL\\tel-uim-plugin-check-edm\\src\\test\\resources\\xsd\\EDM_tel.xsd");
                Schema newSchema = factory.newSchema(edmXsdFile);
...
//        for (File edmXsdFile: new File("C:\\Documents\\EclipseWorkspaces\\TEL\\tel-uim-plugin-check-edm\\src\\test\\resources\\xsd").listFiles()) {
