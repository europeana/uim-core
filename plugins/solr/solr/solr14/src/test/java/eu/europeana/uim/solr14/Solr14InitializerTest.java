 ...
 * @since Aug 7, 2011
 */
public class Solr14InitializerTest {
    ...
    public void testSetupAndStart() throws SolrServerException, IOException {
        Solr14Initializer initializer = new Solr14Initializer("file://./target/solr", "test");
        initializer.initialize(Solr14Initializer.class.getClassLoader());
