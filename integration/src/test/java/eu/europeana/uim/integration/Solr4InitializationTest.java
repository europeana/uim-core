...
public class Solr4InitializationTest extends AbstractIntegrationTest {
    /**
...
// PaxRunnerOptions.vmOption("-Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5006"),
                ...
                mavenBundle().groupId("eu.europeana").artifactId("europeana-uim-plugin-solr4").versionAsInProject(),
