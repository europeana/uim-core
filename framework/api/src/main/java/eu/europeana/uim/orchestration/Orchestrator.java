...
public interface Orchestrator<I> {
     ...
     *
     * @param workflow execution on this workflow
     * @param dataset data set executed in the process
     ...
     * @param workflow execution on this workflow
     * @param dataset data set executed in the process
     * @param properties arbitrary additional settings
     * @return an newly created active execution
     */
    <U extends UimDataSet<I>> ActiveExecution<U, I> executeWorkflow(Workflow<U, I> workflow,
    ...
    /**
     * @param execution pause this execution
     */
    void pause(ActiveExecution<?, I> execution);

    /**
     * @param execution resume this execution
     */
    void resume(ActiveExecution<?, I> execution);

    /**
     * @param execution cancel this execution
     */
