...
/**
 * Extends progress monitor with revising methods to alter progress monitoring.
 *
...
public interface RevisingProgressMonitor extends ProgressMonitor {
    ...
    /**
     * set the start in long java time of the overall progress
     *
     * @param millis
     */
    ...
    /**
     * this revising monitor has been attached to a revisable monitor.
     */
    public void attached();

    /**
     * this revising monitor has been detached to a revisable monitor.
     */
