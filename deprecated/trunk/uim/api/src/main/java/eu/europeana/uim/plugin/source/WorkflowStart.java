...
public interface WorkflowStart<U extends UimDataSet<I>, I> extends ExecutionPlugin<U, I> {
    /**
     * key on execution to keep track of {@link UimDataSet} created during this workflow start (not
     * mandatory, only selected {@link WorkflowStart}s might support this)
     */
    static final String CREATED = "Created";
    /**
     * key on execution to keep track of {@link UimDataSet} updated (existed previously) during this
     * workflow start (not mandatory, only selected {@link WorkflowStart}s might support this)
     */
    static final String UPDATED = "Updated";
    /**
     * key on execution to keep track of {@link UimDataSet} deleted (must not have been existed in
     * UIM before, just marks records as deleted by the provider) during this workflow start (not
     * mandatory, only selected {@link WorkflowStart}s might support this)
     */
