...
public class MongoDBRequestBeanBytesConverter extends
		Converter<byte[], RequestBean> {
	/**
		...
		if (data != null) {
			...
			try {
				...
				throw new RuntimeException(
						"Could not read RequestBean from byte array!", e);
	...
	public byte[] encode(RequestBean data) {
		...
		try {
			...
			throw new RuntimeException("Could not write RequestBean '"
