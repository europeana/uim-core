...
public interface ProgressMonitor {
    ...
    /**
     * Inform the monitor of the name of the sub task we are currently working
     * on.
     *
     * @param subtask
     */
    ...
    /**
     * Set the internal cancel value of the progress monitor. This can be set by
     * the user interface therefore the execution should poll the
     * <code>isCancelled</code> method before every sub task.
     *
     * @param cancelled
     */
