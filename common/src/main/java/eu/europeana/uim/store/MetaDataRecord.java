...
/**
 * This interface defines a highly dynamic model of records consisting of
 * metadata. A meta data record represents the fines unit of a record in the
 * Europeana and The European Library sense.
 *
 * @param <I> generic ID
 *
