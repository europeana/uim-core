...
/**
 * Interface for the access layer to (potentially) different ways to query
 * SugarCRM
 *
...
public interface SugarClient {
     ...
     */
    List<String> getAvailableModules(String session);

    /**
     * Returns a list of the collection records. This includes only the fields
     * visible in the SugarCRM list view.
     *
     * @param session
     * @param query
     * @param maxResults
     ...
     */
    List<Map<String, String>> getCollections(String session, String query, int maxResults);

    /**
     *
     * Returns a list of all providers that match the criteria. This call gets
     ...
     */
    List<Map<String, String>> getProviders(String session, String query, int maxResults);

    /**
     * Returns a list of all collections with the complete record. This call
     * gets first a list of all ids, and then queries again for each entry.
     *
     * @param session the session id
     ...
     * @param offset the offset of the records to pull
     * @return a list of full records
     */
    List<Map<String, String>> getModuleList(String session, String module, String query,
     ...
     */
    Map<String, String> getCollection(String session, String id);
     ...
     */
    boolean updateCollection(String session, String id, Map<String, String> values);
     ...
     * @return the full record: null if none could be retrieved
     */
    Map<String, String> getProvider(String session, String id);
     ...
     * @return true, if the update was successful
     */
    boolean updateProvider(String session, String id, Map<String, String> values);
     ...
     * @return the full record: null if none could be retrieved
     */
    Map<String, String> getContact(String session, String id);
     ...
     * @param internalid the internal id of the record.
     * @return the full record, null if the record was not found
     */
    Map<String, String> getSingleEntryFromInternalId(String session, String module,
            String internalid);
     ...
     * @return the full record, null if the record was not found
     */
    Map<String, String> getSingleEntry(String session, String module, String id,
            String idfield);
     ...
     */
    List<Map<String, String>> getProviderContacts(String session, String id);
     ...
     */
    List<Map<String, String>> getContacts(String session, String query,
     ...
     */
    String getProviderForCollection(String session, String collectionid);

    /**
     * @param session
     * @param mnemonic
     * @return translation for a collection
     */
    List<Map<String, String>> getTranslationsForCollection(String session, String mnemonic);
     ...
     * @return a list of ids corresponding to the relationships: null if an
     * error happened.
     */
    List<String> getRelationsships(String session, String module, String moduleid,
     ...
     */
    String createEntry(String session, String module, Map<String, String> values);
     ...
     * @return relationship
     */
    boolean createRelationsship(String session, String module1, String module1id, String module2,
            String module2id);
