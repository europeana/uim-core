...
public enum RepoxControlledVocabulary implements ControlledVocabularyKeyValue {
    ...
    /**
     * repox identifier key used on maps of providers as ID of the repox
     * aggregators (specific to this implementation)
     */
    AGGREGATOR_REPOX_ID,
    /**
     * repox identifier key used on maps of providers as ID of the repox
     * provider (specific to this implementation)
     */
    PROVIDER_REPOX_ID,
    /**
     * repox identifier key used on maps of collections as ID of the repox
     * collection (specific to this implementation)
     */
    COLLECTION_REPOX_ID,
    /**
     * type of harvesting
