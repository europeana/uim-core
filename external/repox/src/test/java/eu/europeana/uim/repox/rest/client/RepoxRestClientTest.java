...
//        }
    ...
    public void testGetAggregators() throws Exception {
        Source retDs = repoxRestClient.retrieveDataSource("a1051");
        
        Source ds = new Source();
        ds.setId("a1051");
        ds.setDescription("NONE");
        ds.setNameCode("a1051");
        ds.setName("Scientific papers, photographs and correspondence of Erwin Schrödinger and photographs from different art historians");
        ds.setSchema("http://www.europeana.eu/schemas/ese/ESE-V3.3.xsd");
        ds.setMetadataFormat("http://www.europeana.eu/schemas/ese/");
        ds.setOaiSource("https://fedora.phaidra.univie.ac.at/oaiprovider/");
        ds.setOaiSet("europeana");
