...
import eu.europeana.uim.repox.IngestFrequency;
import eu.europeana.uim.repox.client.AggregatorRepoxRestClient;
import eu.europeana.uim.repox.client.DataSourceFunctionsRepoxRestClient;
import eu.europeana.uim.repox.client.DataSourceRepoxRestClient;
import eu.europeana.uim.repox.client.HarvestingRepoxRestClient;
import eu.europeana.uim.repox.client.ProviderRepoxRestClient;
import eu.europeana.uim.repox.client.RecordRepoxRestClient;
...
/**
 * Class implementing REST functionality for accessing the REPOX repository.uikjul.kcv bnm o
 * 
...
public class CompositeRepoxRestClient implements RepoxRestClient {
    ...
    @Override
    public Aggregator retrieveAggregator(String aggregatorId) throws RepoxException {
    ...
    public String scheduleHarvesting(String dsID, DateTime ingestionDate,
        ...
        return harvClient.scheduleHarvesting(dsID, ingestionDate, frequency, isfull);
    }
