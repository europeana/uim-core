 ...
 * {@link WorkflowStart}, followed by an arbitrary number of
 * {@link IngestionPlugin}. Each workflow meaningful name together with a
...
public interface Workflow<U extends UimDataSet<I>, I> {
    ...
    /**
     * @return description of this specific workflow (what does it, what should
     * be the outcome, etc.)
     */
    ...
    /**
     * @param pluginIdentifier unique identifier for ingestion plugins
    ...
    /**
     * @param pluginIdentifier unique identifier for ingestion plugins
     * @return Is this a mandatory plugin, so unsuccesful processing is a
     * failure?
     */
