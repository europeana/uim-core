...
/**
 * Context of a running execution holding execution dependent variables for the
 * plugins etc.
 *
...
public interface ExecutionContext<U extends UimDataSet<I>, I> {
    ...
    /**
     * @param throwable holding heavy errors
     */
    ...
    /**
     * @return the collection iff the dataset is mdr, request, or collection.
     * NULL for provider dataset.
     */
    ...
    /**
     * @param plugin
     * @return a temporary directory, which is only valid for this execution and
     * deleted after the workflow is over (if not overridden by configuration)
     */
